...
git clone https://github.com/sweetbot0/sweetbot.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf sweetbot && rm -rf .telegram-cli && git clone https://github.com/sweetbot0/sweetbot.git && cd superflux-bot && ./launch.sh install && ./launch.sh
~~~~~
